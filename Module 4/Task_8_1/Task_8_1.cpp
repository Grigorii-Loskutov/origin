// Task_8_1.cpp : Задача 1. Клонирование объекта класса
// https://github.com/netology-code/cppl-homeworks/tree/main/10/01
...
public:
    ...
    std::unique_ptr<tridiagonal_matrix> clone() {
        return this ? std::make_unique<tridiagonal_matrix>(*this) : nullptr;
    }
};
